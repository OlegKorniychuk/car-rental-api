...
describe('Car model tests', function() {
  it('Should get 0 results', async function () {
    results = await Car.find();
    results.length.should.be.equal(0);
  });

  it('Should succesfully create a car', async function () {
    const carData = {
  ...
  it('Should have 5 required fields', async function() {
    const carData = {};
    let error;
    try {
      await Car.create(carData);
  ...
  it('Should only accept certain values for car type', async function() {
    const carData = {
      make: '2001 Toyota Corola',
      type: 'type',
      price: 9000,
  ...
  it('Should check for minimal production year', async function() {
    const carData = {
      make: '2001 Toyota Corola',
      type: 'sedan',
      price: 9000,
  ...
  it('Should check for maximal production year', async function() {
    const carData = {
      make: '2001 Toyota Corola',
      type: 'sedan',
      price: 9000,
  ...
  it('Should receive virtual property', async function() {
